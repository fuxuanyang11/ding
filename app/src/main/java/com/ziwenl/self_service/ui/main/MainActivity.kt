...
import com.ziwenl.self_service.ui.new.WebViewActivity
...
class MainActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_stop.setOnClickListener {
            if (PunchCardService.isEmpty()) {
                Toast.makeText(this, "没开启你停个奶子", Toast.LENGTH_SHORT).show()
            }else {
                Toast.makeText(this, "已停止自动打卡", Toast.LENGTH_SHORT).show()
                PunchCardService.stop()
            }
        }
