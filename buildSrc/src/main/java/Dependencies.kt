object Versions {
    const val android_plugin = "7.1.0"
    const val kotlin = "1.6.10"
    const val kotlin_coroutines = "1.3.3"

    const val appcompat = "1.1.0"
    const val jetpack_lifecycle = "2.5.1"
    const val jetpack_viewModel = "2.5.1"
    const val jetpack_room = "2.4.3"
    const val jetpack_navigation = "2.5.2"
    const val jetpack_paging = "2.1.1"

    const val jetpack_activity = "1.4.0"
    const val jetpack_fragment = "1.5.3"
